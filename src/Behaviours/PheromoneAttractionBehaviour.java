...
public class PheromoneAttractionBehaviour extends Behaviour {
  ...
  public PheromoneAttractionBehaviour(Robot r, float dos, VisiblesTypeFilter typeFilter, VisiblesColorFilter colorFilter, Color filterColor) {
    super(r);
    dOfSight = dos;
    strength = 1.0f;
  ...
  public void updateBehaviour(Robot r, float dt) {
    ...
    for (WorldObject i : visibles) {
      if (i.getPosition().getLength() > 20.0f) {
