...
public class BacteriaFrame extends JFrame implements ActionListener, ChangeListener {

  private static BacteriaFrame instance;
  private Board board;
  ...
  public BacteriaFrame() {
    ...
    board = new Board();
    board.setWorld(new BacteriaWorld(700, 700));
    ...
    optionPanel.add(p, gbc);
    {
      ...
      foodSightDistance = new JSlider(JSlider.HORIZONTAL, 0, 100, 60);
