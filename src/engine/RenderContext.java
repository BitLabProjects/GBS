...
public class RenderContext {
	...
	public RenderContext(Matrix4 matrix) {
		// Use a copy because when translating or rotating we don't want to
	...
	private void setCurrentColor() {
		mImmediateRender.color(mColor.getRed() / 255.0f,
				mColor.getGreen() / 255.0f, mColor.getBlue() / 255.0f,
				mColor.getAlpha() / 255.0f);
	}
